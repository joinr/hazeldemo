;;Resting place for legacy promise/queue based mapping examples.

;;LEGACY / SLOW client ops.
;;========================
...
(def responder
  (ch/add-entry-listener (core/get-comms :results)
                         (core/->response-listener (core/get-comms :results) *pending*)))
